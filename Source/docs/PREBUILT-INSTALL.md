...
| **Scripts** | Data, Lua, JavaScript and configuration; no EXE or DLL files | Use only together with the matching **Runtime** archive |
| **Runtime** | Helper executables, DLLs, local runtime and licenses | Use only together with the matching **Scripts** archive |
