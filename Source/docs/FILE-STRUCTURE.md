...
| **Scripts** | Bootstrap files, configuration, Lua, JavaScript, roster data and other non-binary content. It contains no EXE or DLL files. |
| **Runtime** | Executables, DLLs, the bundled local runtime and license files. |
