...
test('remote capture primes a muted media consumer and keeps it silent when LiveKit starts audio again',async()=>{
 ...
 class Context {currentTime=1;sampleRate=48000;destination={};audioWorklet={addModule:async()=>{}};async resume(){}async close(){}createPanner(){const p=()=>({value:0,cancelScheduledValues(){},setTargetAtTime(){}});return {positionX:p(),positionY:p(),positionZ:p(),connect(){},disconnect(){}};}createMediaStreamSource(){return {connect(){sourceConnected=true;},disconnect(){sourceConnected=false;}};}}
