...
- Added optional loot reactions, On by default. One random nearby companion comments on a completed batch, with a 20% ordinary chance and a ten-minute minimum gap. Newly acquired Legendary-tier weapons or clothing get a separate two-minute exception. Storage withdrawals stay silent.
