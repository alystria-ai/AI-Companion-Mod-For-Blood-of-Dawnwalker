# LLM NPC Companions System 0.5.2
...
**Scripts and Runtime are two halves of the same release. Install both 0.5.2 archives.** Neither split archive is a playable standalone package. Do not mix versions.

## Install

1. Close the game.
2. Install UE4SS 1.2.1 RC6 for game version 1.05 and Dawnwalker Mod Menu 1.0.7 or later.
3. Choose **Complete**, or download both **Scripts** and **Runtime** for version 0.5.2.
