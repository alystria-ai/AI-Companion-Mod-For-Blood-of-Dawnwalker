...
public sealed class ModKeyBindings {
    public static readonly string[] Actions={"Menu","SingleText","SingleVoice","GroupText","GroupVoice"};
    readonly Dictionary<string,Keys> keys=new Dictionary<string,Keys>{{"Menu",Keys.F5},{"SingleText",Keys.F6},{"SingleVoice",Keys.F7},{"GroupText",Keys.F8},{"GroupVoice",Keys.F9}};
